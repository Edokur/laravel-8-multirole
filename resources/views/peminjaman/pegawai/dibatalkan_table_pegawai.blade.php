<div class="card">
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="dibatalkan-table">
                <thead>
                    <tr>
...
@push('script')
<script>
    var dibatalkan_table = $('#dibatalkan-table').DataTable({
        "autoWidth": false,
        processing: true,
        serverSide: true,
        ajax: 'dibatalkan_table_pegawai',
        columns: [
            ...
            { data: 'kode_pinjam', name: 'kode_pinjam' },
                ...
                { data: 'status', name: 'status', render:function (data, type, full, meta) {
                    if (full.status == 'Ditolak') {
                        var status = '<span class="badge badge-danger">Ditolak</span>';
                    }
                    return status;
                }},
