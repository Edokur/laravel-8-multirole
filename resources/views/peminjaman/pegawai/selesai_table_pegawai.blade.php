<div class="card">
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="selesai-table">
                <thead>
                    <tr>
...
<script>
    var selesai_table = $('#selesai-table').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: 'selesai_table_pegawai',
        columns: [{data: 'no', name: 'id', className: 'text-center', render: function(data, type, row, meta) {
                ...
                { data: 'status', name: 'status', render:function (data, type, full, meta) {
                    if (full.status == 'Diterima') {
                        var status = '<span class="badge badge-success">Diterima</span>';
                    }
                    return status;
                }},
