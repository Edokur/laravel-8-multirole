              ...
              <div class="card">
                <div class="card-body">
                  <div class="table-responsive">
                    ...
                    <button type="submit" id="terimaPeminjaman" class="btn btn-success float-right">Terima</button>
                    <button type="submit" id="tolakPeminjaman" class="btn btn-danger float-right mr-3">Tolak</button>
                  </div>
                </div>
            </div>
          </div>
...
<script>
    $(document).ready(function(){
        ...
        $("#terimaPeminjaman").click(function(e){
            e.preventDefault();
            var data = {
            ...
            $.ajax({
                    data: data,
                    url: "{!! url()->current() !!}/terimaPeminjaman",
                    method: "POST",
                    type: 'json',
            ...
            $("#tolakPeminjaman").click(function(e){
            e.preventDefault();
            var data = {
                'kode_pinjam': $("#kode_pinjam").val(),
                'id_pinjam': $("#id_pinjam").val(),
            ...
            $.ajax({
                    data: data,
                    url: "{!! url()->current() !!}/tolakPeminjaman",
                    method: "POST",
                    type: 'json',
                    success:function(response){
                        console.log(response)
