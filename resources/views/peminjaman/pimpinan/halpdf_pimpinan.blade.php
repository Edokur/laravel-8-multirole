...
<div class="section-body">
    <a href="/peminjaman_pimpinan"  data-original-title="kembali" class="btn btn-primary"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg" height="1.2em" viewBox="0 0 448 512"><style>svg{fill:#ffffff}</style><path d="M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.2 288 416 288c17.7 0 32-14.3 32-32s-14.3-32-32-32l-306.7 0L214.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z"/></svg> Kembali</a>
    <div class="row mt-sm-4">
        <div class="col-12 col-md-12 col-lg-12">
            <div class="card">
                ...
                <form action="/peminjaman_pimpinan/halpdf/cetakpdf" method="post">
                <div class="card-body">
                    ...
                    <div class="card-footer text-right">
                        ...
                        <button type="submit" id="saveBtnCetakBarang" class="btn btn-success">Submit</button>
                    </div>
                </form> 
            </div>
        </div>
...
<script>
    $(document).ready(function(){
        ...
        $("#saveBtnCetakBarang").click(function(e){
