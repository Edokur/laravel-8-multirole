    ...
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
          ...
          @if(auth()->user()->role == "Pimpinan")
            <li class="{{ ($title == 'Data Peminjaman') ? 'active' : '' }}"><a class="nav-link" href="/peminjaman_pimpinan"><i class="far fa-square"></i> <span>Data Peminjaman</span></a></li>
            <li class="{{ ($title == 'Data Barang') ? 'active' : '' }}"><a class="nav-link" href="/barang_pimpinan"><i class="fas fa-th"></i> <span>Data Barang</span></a></li>
          @endif
          ...
          @if (auth()->user()->role=="Pegawai")
          <li class="{{ ($title == 'Keranjang Pinjam') ? 'active' : '' }}"><a class="nav-link" href="/keranjang_pegawai"><i class="fas fa-shopping-cart"></i> <span>Keranjang Pinjam</span></a></li>
          @endif
      </ul>
    </aside>
  </div>
