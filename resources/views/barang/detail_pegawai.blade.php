...
<section class="section">
    ...
    <div class="section-body">
        <a href="/barang"  data-original-title="kembali" class="btn btn-primary mb-3"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg" height="1.2em" viewBox="0 0 448 512"><style>svg{fill:#ffffff}</style><path d="M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.2 288 416 288c17.7 0 32-14.3 32-32s-14.3-32-32-32l-306.7 0L214.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z"/></svg> Kembali</a><br>
            <div class="row">
            <div class="col-12">
                <div class="card">
...
<script>
    $(document).ready(function(){
        ...
        var barangDetail_table = $('#Pegawai_Detailbarang_table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{!! url()->current() !!}",
            columns: [
